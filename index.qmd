...
[^nhst-caveat]: At least for null hypothesis significance testing (NHST). 

    Bayesian tests are different because there's no such thing as statistical significance there and you're asking different inferential questions entirely.
