...
- [ ] Finish regular p-values page
- [ ] Bigger image in the simulation parameters section (it's currently really short and the text is tiny)
- [ ] Better "Resample" button in step 2
