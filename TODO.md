...
- [x] Null histogram color in OJS should be grey
- [x] Remove glyph from footnotes on home page

# Simulation

- [x] Finish regular p-values page
- [x] Bigger image in the simulation parameters section (it's currently really short and the text is tiny)
- [x] Better "Resample" button in step 2
- [x] Better spacing between the tables in step 2
- [x] Better spacing after tables and plots
